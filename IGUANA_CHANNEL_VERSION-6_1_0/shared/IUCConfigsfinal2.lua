...
iucConf.dev = {
   ...
   ['patientCsvPath'] = '/home/centos/iuc/final2/',
   ['patientCsvFile'] = 'PatientData.txt',
	
   -- Configurations for patient DB file
   ['patientDbPath'] = '/home/centos/iuc/final2/',
...
iucConf.prod = {
   -- Configurations for patient csv File
   ['patientCsvPath'] = '/home/centos/iuc/prod/final2/',
   ['patientCsvFile'] = 'PatientData.txt',
	
   -- Configurations for patient DB file
   ['patientDbPath'] = '/home/centos/iuc/prod/final2/',
   ['patientDbFile'] = 'PatientData.sqlite'
}
